...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelGeneration', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.ModelGeneration();
      });

      it('should create an instance of ModelGeneration', function() {
        // TODO: update the code to test ModelGeneration
        expect(instance).to.be.a(RemapdbJsSdk.ModelGeneration);
      });
