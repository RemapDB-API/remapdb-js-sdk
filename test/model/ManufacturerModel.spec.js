...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ManufacturerModel', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.ManufacturerModel();
      });

      it('should create an instance of ManufacturerModel', function() {
        // TODO: update the code to test ManufacturerModel
        expect(instance).to.be.a(RemapdbJsSdk.ManufacturerModel);
      });
