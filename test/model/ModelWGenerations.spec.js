...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelWGenerations', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.ModelWGenerations();
      });

      it('should create an instance of ModelWGenerations', function() {
        // TODO: update the code to test ModelWGenerations
        expect(instance).to.be.a(RemapdbJsSdk.ModelWGenerations);
      });
      ...
      it('should have the property generations (base name: "generations")', function() {
        // TODO: update the code to test the property generations
        expect(instance).to.have.property('generations');
        // expect(instance.generations).to.be(expectedValueLiteral);
      });
