...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EngineStagePerformance', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.EngineStagePerformance();
      });

      it('should create an instance of EngineStagePerformance', function() {
        // TODO: update the code to test EngineStagePerformance
        expect(instance).to.be.a(RemapdbJsSdk.EngineStagePerformance);
      });
      ...
      it('should have the property topSpeed (base name: "top_speed")', function() {
        // TODO: update the code to test the property topSpeed
        expect(instance).to.have.property('topSpeed');
        // expect(instance.topSpeed).to.be(expectedValueLiteral);
      });

      it('should have the property zeroToHundred (base name: "zero_to_hundred")', function() {
        // TODO: update the code to test the property zeroToHundred
        expect(instance).to.have.property('zeroToHundred');
        // expect(instance.zeroToHundred).to.be(expectedValueLiteral);
      });
