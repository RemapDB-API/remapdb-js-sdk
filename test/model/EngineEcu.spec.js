...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EngineEcu', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.EngineEcu();
      });

      it('should create an instance of EngineEcu', function() {
        // TODO: update the code to test EngineEcu
        expect(instance).to.be.a(RemapdbJsSdk.EngineEcu);
      });
