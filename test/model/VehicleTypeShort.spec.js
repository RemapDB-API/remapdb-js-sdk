...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VehicleTypeShort', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.VehicleTypeShort();
      });

      it('should create an instance of VehicleTypeShort', function() {
        // TODO: update the code to test VehicleTypeShort
        expect(instance).to.be.a(RemapdbJsSdk.VehicleTypeShort);
      });
