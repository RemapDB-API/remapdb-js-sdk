...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EngineShort', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.EngineShort();
      });

      it('should create an instance of EngineShort', function() {
        // TODO: update the code to test EngineShort
        expect(instance).to.be.a(RemapdbJsSdk.EngineShort);
      });
