...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WorkMethod', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.WorkMethod();
      });

      it('should create an instance of WorkMethod', function() {
        // TODO: update the code to test WorkMethod
        expect(instance).to.be.a(RemapdbJsSdk.WorkMethod);
      });
