...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GenerationWEngines', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.GenerationWEngines();
      });

      it('should create an instance of GenerationWEngines', function() {
        // TODO: update the code to test GenerationWEngines
        expect(instance).to.be.a(RemapdbJsSdk.GenerationWEngines);
      });
      ...
      it('should have the property yearEnd (base name: "year_end")', function() {
        // TODO: update the code to test the property yearEnd
        expect(instance).to.have.property('yearEnd');
        // expect(instance.yearEnd).to.be(expectedValueLiteral);
      });
