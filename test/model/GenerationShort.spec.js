...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GenerationShort', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.GenerationShort();
      });

      it('should create an instance of GenerationShort', function() {
        // TODO: update the code to test GenerationShort
        expect(instance).to.be.a(RemapdbJsSdk.GenerationShort);
      });
