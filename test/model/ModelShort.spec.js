...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ModelShort', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.ModelShort();
      });

      it('should create an instance of ModelShort', function() {
        // TODO: update the code to test ModelShort
        expect(instance).to.be.a(RemapdbJsSdk.ModelShort);
      });
