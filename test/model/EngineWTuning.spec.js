...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EngineWTuning', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.EngineWTuning();
      });

      it('should create an instance of EngineWTuning', function() {
        // TODO: update the code to test EngineWTuning
        expect(instance).to.be.a(RemapdbJsSdk.EngineWTuning);
      });
      ...
      it('should have the property tuning (base name: "tuning")', function() {
        // TODO: update the code to test the property tuning
        expect(instance).to.have.property('tuning');
        // expect(instance.tuning).to.be(expectedValueLiteral);
      });
