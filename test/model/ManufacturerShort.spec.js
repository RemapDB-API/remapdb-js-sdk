...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ManufacturerShort', function() {
      beforeEach(function() {
        instance = new RemapdbJsSdk.ManufacturerShort();
      });

      it('should create an instance of ManufacturerShort', function() {
        // TODO: update the code to test ManufacturerShort
        expect(instance).to.be.a(RemapdbJsSdk.ManufacturerShort);
      });
