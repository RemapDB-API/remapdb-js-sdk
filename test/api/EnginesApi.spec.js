...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RemapdbJsSdk.EnginesApi();
  });
    ...
    describe('EnginesApi', function() {
      describe('getEngine', function() {
        it('should call getEngine successfully', function(done) {
          // TODO: uncomment, update parameter values for getEngine call and complete the assertions
          /*
          var opts = {};

          instance.getEngine(engineId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(RemapdbJsSdk.EngineWTuning);
      ...
      describe('listEngines', function() {
        it('should call listEngines successfully', function(done) {
          // TODO: uncomment, update parameter values for listEngines call and complete the assertions
          /*
          var opts = {};

          instance.listEngines(generationId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(RemapdbJsSdk.Engine);
            }
