...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new RemapdbJsSdk.ModelsApi();
  });
    ...
    describe('ModelsApi', function() {
      describe('getModel', function() {
        it('should call getModel successfully', function(done) {
          ...
          instance.getModel(modelId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(RemapdbJsSdk.ModelWGenerations);
      ...
      describe('listModels', function() {
        it('should call listModels successfully', function(done) {
          ...
          instance.listModels(manufacturerId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            ...
            for (let p in dataCtr) {
              let data = dataCtr[p];
              expect(data).to.be.a(RemapdbJsSdk.ManufacturerModel);
            }
